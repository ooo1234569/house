...
//
//import com.example.myapplication9.BaseHolder;
//
...
//        if (viewType == HEADER0) {
//            return new BannerHolder(1,headView0,1);
...
//            System.out.println("BannerHolder");
//            BannerSlider bannerSlider=(BannerSlider)itemView.findViewById(R.id.banner_slider1);
//        }
//    }
//    //10个子菜单
//    class GridMenuHolder extends BaseHolder{
//        public GridMenuHolder(int viewId, ViewGroup parent, int viewType){
//            super(viewId, parent, viewType);
//            GridView  gridView=(GridView)itemView.findViewById(R.id.gridView);
//        }
//    }
//    class RvHolder extends BaseHolder{
//        public RvHolder(int viewId, ViewGroup parent, int viewType) {
//            super(viewId, parent, viewType);
//            RecyclerView recyclerView=(RecyclerView) itemView.findViewById(R.id.tuijianrv);
//        }
//    }
//
////    //普通的Holder
